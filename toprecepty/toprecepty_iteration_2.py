...
recipe_list = [recipe_list[6]]
i = 1
for recipe in recipe_list:

    recipe_detail_html = urlopen('https://www.toprecepty.cz/recept/74023-jednoduchy-kureci-salat-s-vejci-cibuli-a-rajcaty/').read()
    ...
    for item in ingredient_items:
        ...
        if (ingredient_section is not None):
            ingredient_dict["ingredient_section"] = ingredient_section.get_text()
